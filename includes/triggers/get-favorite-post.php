...
class AutomatorWP_Favorites_Get_Favorite_Post extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User gets a favorite on a post', 'automatorwp-favorites' ),
            'select_option'     => __( 'User <strong>gets a favorite</strong> on a post', 'automatorwp-favorites' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User gets a favorite on %1$s %2$s time(s)', 'automatorwp-favorites' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User gets a favorite on %1$s', 'automatorwp-favorites' ), '{post}' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Post:', 'automatorwp-favorites' ),
                    'option_none_label' => __( 'any post', 'automatorwp-favorites' ),
