...
class AutomatorWP_Favorites_Favorite_Post extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User favorites a post', 'automatorwp-favorites' ),
            'select_option'     => __( 'User <strong>favorites</strong> a post', 'automatorwp-favorites' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User favorites %1$s %2$s time(s)', 'automatorwp-favorites' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User favorites %1$s', 'automatorwp-favorites' ), '{post}' ),
